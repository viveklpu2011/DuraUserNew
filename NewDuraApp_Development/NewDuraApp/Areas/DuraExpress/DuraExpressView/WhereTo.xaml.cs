...
namespace NewDuraApp.Areas.DuraExpress.DuraExpressView
{
    ...
    public partial class WhereTo : ContentPage
    {
        ...
        public WhereTo()
        {
            ...
            //App.Locator.WhereTo.InitilizeData();
        }
        ...
        //        App.Locator.WhereTo.WhereToLocation = location;
        //        var PlacemarkAddress = await LocationHelpers.GetAddressBasedOnLatLong(location);
        //        App.Locator.WhereTo.PlacemarkAddress = await LocationHelpers.GetAddressBasedOnLatLong(location);
        //        if (PlacemarkAddress != null)
        //        {
        //            App.Locator.WhereTo.Address1 = $"{PlacemarkAddress?.FeatureName} {PlacemarkAddress?.SubAdminArea}";
        //            App.Locator.WhereTo.Address2 = $"{PlacemarkAddress?.Locality} {PlacemarkAddress?.PostalCode} {PlacemarkAddress?.CountryName}";
        //        }
        //    }
        //}
        protected override void OnAppearing()
        {
            ...
            {
                this.WhenAnyValue(v => v.viewModelLocator.WhereTo.Position)
                ...
                Observable.FromEventPattern<MapClickedEventArgs>(
                    ...
                    mc => mapPickupLocation.MapClicked -= mc)
                    .Subscribe(ev => viewModelLocator.WhereTo.ExecuteSetAddress.Execute(ev.EventArgs.Position))
                    .DisposeWith(_disposable);
            });
        }
        ...
        private Unit SetPin(Position position)
        {
            ...
            {
                Label = "The Place",
                Address = $"{App.Locator.WhereTo.Address1}, {App.Locator.WhereTo.Address2}",
                Type = PinType.Place,
                Position = position,
        ...
        {
            await App.Locator.WhereTo.AddressReturnCommandExecute();
        }
    }
}