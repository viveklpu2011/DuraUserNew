    ...
    public class GoogleMapsApiService : IGoogleMapsApiService
    {
        ...
        public async Task<GoogleDirection> GetDirections(string originLatitude, string originLongitude, string destinationLatitude, string destinationLongitude)
        {
            ...
            using (var httpClient = CreateClient())
            {
                ...
                var response = await httpClient.GetAsync($"api/directions/json?origin={originLatitude},{originLongitude}&destination={destinationLatitude},{destinationLongitude}&key={_googleMapsKey}").ConfigureAwait(false);
